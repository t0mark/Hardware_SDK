...
def launch_setup(context, *args, **kwargs):
    ...
    # Get URDF via xacro for ROAS robot
    ...
    # Build MoveIt config with ROAS URDF and custom SRDF
    moveit_config = (
        ...
        .robot_description_semantic(file_path=PathJoinSubstitution(
            [FindPackageShare("roas2_bringup"), "config", "moveit", "roas.srdf"]
        ).perform(context))
